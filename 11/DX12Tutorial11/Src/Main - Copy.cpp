...
void Update(double delta)
{
	...
	if (XInputGetState(0, &xistate) == ERROR_SUCCESS) {
		gamepad.buttons = 0;
		gamepad.buttons |= xistate.Gamepad.sThumbLY > XINPUT_GAMEPAD_LEFT_THUMB_DEADZONE ? GamePad::DPAD_UP : 0;
		gamepad.buttons |= xistate.Gamepad.sThumbLY < -XINPUT_GAMEPAD_LEFT_THUMB_DEADZONE ? GamePad::DPAD_DOWN : 0;
		gamepad.buttons |= xistate.Gamepad.sThumbLX < -XINPUT_GAMEPAD_LEFT_THUMB_DEADZONE ? GamePad::DPAD_LEFT : 0;
		gamepad.buttons |= xistate.Gamepad.sThumbLX > XINPUT_GAMEPAD_LEFT_THUMB_DEADZONE ? GamePad::DPAD_RIGHT : 0;
		gamepad.buttons |= xistate.Gamepad.wButtons & XINPUT_GAMEPAD_DPAD_UP ? GamePad::DPAD_UP : 0;
		gamepad.buttons |= xistate.Gamepad.wButtons & XINPUT_GAMEPAD_DPAD_DOWN ? GamePad::DPAD_DOWN : 0;
		gamepad.buttons |= xistate.Gamepad.wButtons & XINPUT_GAMEPAD_DPAD_LEFT ? GamePad::DPAD_LEFT : 0;
		gamepad.buttons |= xistate.Gamepad.wButtons & XINPUT_GAMEPAD_DPAD_RIGHT ? GamePad::DPAD_RIGHT : 0;
		gamepad.buttons |= xistate.Gamepad.wButtons & XINPUT_GAMEPAD_A ? GamePad::A : 0;
		gamepad.buttons |= xistate.Gamepad.wButtons & XINPUT_GAMEPAD_B ? GamePad::B : 0;
		gamepad.buttons |= xistate.Gamepad.wButtons & XINPUT_GAMEPAD_X ? GamePad::X : 0;
		gamepad.buttons |= xistate.Gamepad.wButtons & XINPUT_GAMEPAD_Y ? GamePad::Y : 0;
		gamepad.buttons |= xistate.Gamepad.wButtons & XINPUT_GAMEPAD_LEFT_SHOULDER ? GamePad::L : 0;
		gamepad.buttons |= xistate.Gamepad.wButtons & XINPUT_GAMEPAD_RIGHT_SHOULDER ? GamePad::R : 0;
		gamepad.buttons |= xistate.Gamepad.wButtons & XINPUT_GAMEPAD_START ? GamePad::START : 0;
	}
